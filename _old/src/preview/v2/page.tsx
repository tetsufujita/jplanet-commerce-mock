...
export const metadata: Metadata = {
  description: "Internal preview — v2 build (Shopify Enterprise layout × Lusion motion).",
  robots: { follow: false, index: false },
  title: "Andes v2 (preview)",
};

const UNSPLASH = (id: string) => `https://images.unsplash.com/${id}?w=1600&q=80&auto=format&fit=crop`;

export default async function V2PreviewPage({ params }: PageProps) {
  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden bg-[#0A1428] text-white">
      {/* Single page atmosphere — fixed gradient that all sections share */}
      <div
        aria-hidden
      ...
      <main className="relative z-10" id="main">
        <HeroV2
          copy={{
            ...
            eyebrow: "Andes Inc. · Agentic Commerce for LATAM",
            line1: hero("line1"),
            line2: hero("line2"),
          }}
          locale={locale}
          ...
          videoPoster={UNSPLASH("photo-1543059080-f9b1272213d5")}
          videoSrcs={[
            "/video/sp-avenue-twilight.mp4",
            "/video/christ-redeemer.mp4",
            "/video/whatsapp-scene.mp4",
            "/video/street-soccer.mp4",
            "/video/stadium-soccer.mp4",
            "/video/copacabana-dawn.mp4",
            "/video/favela-twilight.mp4",
            "/video/joyful-customer.mp4",
            "/video/packaging-hands.mp4",
            "/video/courier-motorcycle.mp4",
            "/video/doorstep-package.mp4",
            "/video/liberdade-dusk.mp4",
            "/video/rio-coast-sunset.mp4",
            "/video/whatsapp-chat.mp4",
          ]}
        />
        ...
        <BusinessFeatureV2
          ...
          bullets={[
            {
              body: "5 億人の生活基盤に直接届ける",
              number: "01",
              title: "WhatsApp エージェント",
            },
            {
              body: "日本商品の catalog 全件、Phase 1 から",
              number: "02",
              title: "日韓品質",
            },
          ]}
